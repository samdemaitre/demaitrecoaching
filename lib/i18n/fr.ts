...
export const fr: Translations = {
  ...
  hybridCoaching: {
    ...
    card2Title: "Transformation corporelle complète", card2Subtitle: "Un parcours structuré en 4 phases",
    card2Saving: "vs. Q4 350 mois par mois — économisez Q351",
    ...
    card2F1: "16 séances en personne au total", card2F2: "Programme adapté à chaque phase",
    card2F3: "Plan nutritionnel complet", card2F4: "WhatsApp + bilans hebdomadaires",
    card2F5: "Photos de progression avant et après", card2F6: "Paiement intégral à l'avance",
