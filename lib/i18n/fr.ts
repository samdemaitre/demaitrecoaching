...
export const fr: Translations = {
  nav: {
    home: "Accueil", about: "À propos", services: "Services", faq: "FAQ", contact: "Contact", bookCall: "Demander une Consultation",
    dropdown: {
  ...
  common: {
    bookFreeCall: "Demander une Consultation", getStarted: "Commencer", apply: "Postuler maintenant",
  ...
  home: {
    ...
    statsIntro: "Plus d'une décennie de coaching auprès de personnes ambitieuses qui refusent de se contenter de moins — en Belgique et dans le monde entier.",
    statsClientsDesc: "Des personnes ambitieuses en Belgique et dans le monde entier qui ont transformé leur corps — et conservé leurs résultats.",
    statsYearsDesc: "Plus d'une décennie de coaching fondé sur la science, appuyé par une licence en Éducation Physique et Sciences du Mouvement.",
  ...
  meetCoach: {
    ...
    photo2Caption: "Powerlifting — toujours présent dans ma vie",
    photo3Caption: "Aventure — les Andes, les océans et au-delà",
    photo4Caption: "Coaching en action",
    testimonialQuote: "Sam a un œil incroyable pour la technique — il repère et corrige les moindres détails de ma posture avant qu'ils ne deviennent un problème. Les séances sont intenses, mais je me sens toujours en sécurité et bien encadrée. Et on ne s'ennuie jamais : chaque entraînement est différent, et l'ambiance me donne vraiment envie de venir m'entraîner.",
    testimonialAuthor: "Els C., 54", testimonialRole: "Cliente · Belgique",
  ...
  personalTraining: {
    ...
    card1F1: "60 min par séance", card1F2: "Lieu de votre choix", card1F3: "Programme mensuel", card1F4: "Directives nutritionnelles",
    ...
    card2F1: "60 min par séance", card2F2: "Lieu de votre choix", card2F3: "Programme mensuel", card2F4: "Directives nutritionnelles",
  ...
  contact: {
    ...
    formError: "Une erreur s'est produite lors de l'envoi de votre message. Réessayez ou contactez-moi directement sur WhatsApp.",
