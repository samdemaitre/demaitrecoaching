...
export const nl: Translations = {
  ...
  meetCoach: {
    ...
    body1: "Ik ben op mijn best als ik beweeg — of dat nu onder water is, op een berg, of onder een halter.",
    body2: "Mijn naam is Sam. Ik ben 36, oorspronkelijk uit België, en eerder dit jaar ben ik naar Guatemala verhuisd — aangetrokken door de mensen die ik het meeste liefheb, mijn vriendin en onze dochter, en eerlijk gezegd door het gevoel dat dit precies is waar ik nu moet zijn.",
    ...
    cred4Title: "Van absolute beginner tot ervaren atleet — ik specialiseer me in mensen sterker maken en hun energie terugbrengen.", cred4Desc: "",
