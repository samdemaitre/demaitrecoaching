...
export const nl: Translations = {
  ...
  footer: {
    ...
    tagline: "Coaching op maat. Resultaat voor het leven.", copyright: "Alle rechten voorbehouden.",
  ...
  common: {
    ...
    ctaQuote: "Na twaalf jaar is het niet de wetenschap die me nog steeds drijft — het is het moment waarop een klant beseft dat hij sterker is dan hij dacht.",
  },
  home: {
    eyebrow: "Personal Training · Guatemala-Stad & Online",
    h1: "Stop met experimenteren.", h1Italic: "Begin met presteren.",
    ...
    statsIntro: "Meer dan tien jaar coaching voor mensen die het beste uit zichzelf willen halen — in België en wereldwijd.",
    ...
    lakeQuoteItalic: "wat je denkt dat mogelijk is.",
    lakeLocation: "Volcán San Pedro · Atitlánmeer",
    pillarsEyebrow: "De methode", pillarsHeading: "Vier pijlers van succes",
    ...
    accountabilityTitle: "Verantwoording", accountabilityBody: "Regelmatige check-ins, progress tracking en constante ondersteuning om je op koers te houden.",
    longevityTitle: "Duurzaamheid", longevityBody: "Train voor een leven lang. We bouwen gewoontes en bewegingskwaliteit die je decennialang van dienst zijn.",
  ...
  meetCoach: {
    ...
    body5: "Buiten de sportschool is avontuur nooit ver weg. Ik heb drie jaar lang solo de wereld rondgereisd, bergen beklommen in de Andes en gefreedived in tropische wateren. Ik train hard, eet goed en probeer de dingen te leven die ik mijn klanten vraag te doen. Guatemala heeft me een nieuw thuis gegeven, een gezin om iets voor te bouwen, en een reden om hier iets te creëren waar ik écht trots op ben.",
  ...
  whyUs: {
    ...
    d2Title: "Evidence based programming", d2Body: "Ik gok niet. Elke trainings- en voedingsbeslissing die ik maak, is onderbouwd met onderzoek en ervaring. Je krijgt methodes die écht werken — geen trends, geen snelkoppelingen.",
    ...
    d4Title: "Aandacht voor elk detail", d4Body: "Je zult je hier nooit een nummer voelen. Elk bericht wordt beantwoord, elke check-in wordt serieus genomen en jouw programma evolueert voortdurend naarmate jij dat ook doet.",
  ...
  personalTraining: {
    ...
    includes: ["Program Design", "Voedingscoaching", "Training thuis, in de gym of op locatie naar keuze", "Progress Tracking", "WhatsApp ondersteuning"],
  ...
  contact: {
    ...
    body: "Of je nu klaar bent om met een programma te starten of gewoon benieuwd bent naar wat mogelijk is, ik hoor graag van je. Vraag een gesprek aan — duurt minder dan 60 seconden, geen verplichtingen.",
