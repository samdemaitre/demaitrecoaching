...
export const es: Translations = {
  ...
  home: {
    ...
    statsIntro: "Más de una década entrenando a personas ambiciosas que no se conforman — en Ciudad de Guatemala y en todo el mundo.",
    statsClientsDesc: "Personas ambiciosas en Ciudad de Guatemala y en todo el mundo que transformaron su cuerpo — y mantuvieron los resultados.",
