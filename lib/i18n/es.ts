...
export const es: Translations = {
  ...
  meetCoach: {
    ...
    body1: "Sam de Maître ha pasado más de una década estudiando la ciencia y el arte del rendimiento humano. Nacido de una pasión por la fuerza y la frustración con el coaching genérico, fundó De Maître Coaching para ofrecer algo genuinamente diferente: una experiencia de lujo orientada a resultados para quienes se niegan a conformarse.",
    body2: "Con base en Ciudad de Guatemala y clientes en Europa y las Américas, el enfoque de Sam combina programación basada en evidencia con una comprensión profunda del estilo de vida, la psicología y las ambiciones de cada individuo. Cada cliente recibe un programa construido desde cero — sin plantillas, sin atajos.",
    signature: "Sam de Maître", role: "Fundador · Head Coach",
    ...
    cred4Title: "Especialista en Recomposición Corporal", cred4Desc: "Protocolos de pérdida de grasa y ganancia muscular simultánea",
    testimonialQuote: "Trabajar con Sam lo cambió todo. Había probado tres coaches antes y nunca había obtenido resultados así. Su atención al detalle e inversión genuina en mi progreso son incomparables.",
  ...
  ourGoals: {
    ...
    body: "De Maître Coaching fue fundado con un propósito claro: ofrecer coaching de élite con la atención, el rigor y los estándares que merecen las personas ambiciosas. Estos son los objetivos que guían todo lo que hacemos.",
    g1Number: "01", g1Title: "Transformar a Cada Cliente", g1Body: "Nuestro objetivo principal es simple: lograr una transformación física medible y significativa para cada cliente que se comprometa con el proceso. No algunos clientes. Todos.",
    g2Number: "02", g2Title: "Elevar el Estándar del Coaching", g2Body: "La industria del entrenamiento personal está saturada de mediocridad. De Maître Coaching existe para demostrar que el coaching puede ser riguroso, personalizado y genuinamente lujoso — todo a la vez.",
    g3Number: "03", g3Title: "Construir Hábitos de por Vida", g3Body: "Un resultado que desaparece seis meses después no es un resultado. Construimos hábitos de entrenamiento, disciplina nutricional y una relación con el ejercicio que dura toda la vida.",
    g4Number: "04", g4Title: "Hacer la Salud No Negociable", g4Body: "Para los profesionales ambiciosos, la salud a menudo se sacrifica por el éxito. Nuestro objetivo es demostrar que el rendimiento de élite en el gimnasio y en la vida no son prioridades en competencia — son lo mismo.",
    missionEyebrow: "Nuestra Misión", missionQuote: "Transformar la manera en que las personas ambiciosas abordan su salud — ofreciendo programas a la altura de su ambición y un estándar de servicio que refleja su estándar de vida.", missionAttr: "— De Maître Coaching",
  ...
  personalTraining: {
    ...
    card2F1: "Programa mensual de entrenamiento", card2F2: "Directrices nutricionales", card2F3: "Prepago — las sesiones caducan en 30 días",
  ...
  hybridCoaching: {
    ...
    card1Title: "Coaching híbrido", card1Subtitle: "4 sesiones + soporte remoto completo",
    card1F1: "4 sesiones presenciales / mes", card1F2: "Programa actualizado cada 2 semanas",
    card1F3: "Nutrición ajustada mensualmente", card1F4: "WhatsApp + check-in semanal", card1F5: "Informe mensual de progreso",
    card2Title: "Transformación corporal completa", card2Subtitle: "Viaje estructurado en 4 fases",
    card2Saving: "vs. Q4.350 mes a mes — ahorra Q351",
    phaseW1: "Semanas 1–3", phase1: "Base", phaseW2: "Semanas 4–6", phase2: "Construcción",
    phaseW3: "Semanas 7–9", phase3: "Intensidad", phaseW4: "Semanas 10–12", phase4: "Pico",
    card2F1: "16 sesiones presenciales en total", card2F2: "Programa adaptado en cada fase",
    card2F3: "Plan nutricional completo", card2F4: "WhatsApp + check-ins semanales",
    card2F5: "Fotos de progreso antes y después", card2F6: "Pago completo por adelantado",
  ...
  onlineCoaching: {
    ...
    cardF3: "Directrices nutricionales", cardF4: "WhatsApp + check-in semanal",
    cardF5: "Seguimiento mensual del progreso", cardF6: "Compromiso mínimo de 1 mes",
