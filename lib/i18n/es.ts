...
export const es: Translations = {
  ...
  home: {
    eyebrow: "Entrenamiento Personal · Ciudad de Guatemala y Online",
    ...
    lakeLocation: "Ciudad de Guatemala · Guatemala",
  ...
  meetCoach: {
    ...
    body1: "",
    body2: "Hola, me llamo Sam. Tengo 36 años, soy originario de Bélgica y el año pasado me mudé definitivamente a Guatemala — después de un par de años yendo y viniendo, atraído por las personas que más amo, mi novia y nuestra hija, y honestamente, por la sensación de que este es exactamente el lugar donde debo estar.",
