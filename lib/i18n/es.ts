...
export const es: Translations = {
  ...
  hybridCoaching: {
    ...
    card3Title: "Transformación 12 Semanas", card3Subtitle: "Viaje estructurado en 4 fases",
    ...
    card3F1: "16 sesiones presenciales en total", card3F2: "Programa adaptado en cada fase",
    card3F3: "Plan nutricional completo", card3F4: "WhatsApp + check-ins semanales",
    card3F5: "Fotos de progreso antes y después", card3F6: "Pago completo por adelantado",
