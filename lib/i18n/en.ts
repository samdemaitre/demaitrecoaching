export const en = {
  ...
  home: {
    ...
    tagline: "Tailored programs for anyone ready to show up.",
  ...
  meetCoach: {
    ...
    body1: "",
    body2: "Hi, my name is Sam. I'm 36, originally from Belgium, and earlier this year I made the move to Guatemala — drawn here by the people I love most, my girlfriend and our daughter, and honestly, by a feeling that this is exactly where I'm supposed to be right now.",
  ...
  personalTraining: {
    ...
    card1F1: "60 min per session", card1F2: "Location of your choice", card1F3: "Monthly programme", card1F4: "Nutrition guidelines", card1F5: "Prepaid — sessions expire in 30 days",
    ...
    card2F1: "60 min per session", card2F2: "Location of your choice", card2F3: "Monthly programme", card2F4: "Nutrition guidelines", card2F5: "Prepaid — sessions expire in 90 days",
    addOnsTitle: "Add-ons",
