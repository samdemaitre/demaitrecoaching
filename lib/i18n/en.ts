export const en = {
  ...
  home: {
    ...
    tagline: "Tailored programs for driven individuals.",
    body: "De Maître Coaching delivers elite personal training in Guatemala City and worldwide. Every program is built around your goals, your schedule, and your potential.",
    ...
    strengthTitle: "Strength", strengthBody: "Progressive overload programs built around your goals, schedule, and available equipment.",
  ...
  meetCoach: {
    ...
    body2: "Based in Guatemala City with clients across Europe and the Americas, Sam's approach blends evidence-based programming with a deep understanding of each individual's lifestyle, psychology, and ambitions. Every client gets a program built from scratch — no templates, no shortcuts.",
  ...
  ourGoals: {
    ...
    missionEyebrow: "Our Mission", missionQuote: "To transform the way driven individuals approach their health — by delivering programs worthy of their ambition, and a standard of service that reflects their standard of life.", missionAttr: "— De Maître Coaching",
