export const en = {
  ...
  home: {
    ...
    statsIntro: "Over a decade of coaching driven individuals who refuse to settle — in Guatemala City and across the world.",
    statsClientsDesc: "Driven individuals in Guatemala City and worldwide who've transformed their bodies — and kept the results.",
