      ...
      <section className="py-20 px-6 bg-cream2">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* ── Card 2 · Full body transformation (accent) ── */}
            <div className="relative bg-cream rounded-2xl border-2 border-gold p-8 flex flex-col gap-6">
              ...
              <div>
                ...
                <p className="font-dmsans text-xs text-text-muted mt-1">{h.card2Saving}</p>
              </div>
              ...
              <ul className="flex flex-col gap-3 flex-1">
                {[h.card2F1, h.card2F2, h.card2F3, h.card2F4, h.card2F5, h.card2F6].map((f) => (
